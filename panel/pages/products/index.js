...
const Index = () => {
  ...
  const [deleteData, deleteProduct] = useMutation(DELETE_CATEGORY);
  ...
  // if (!data) return <div>{JSON.stringify(data.getAllProducts, null, 2)}</div>;
        ...
        <div className='-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8'>
          {data &&
            ...
            data.getAllProducts.length === 0 && (
              <Alert>Nenhum produto criado até o momento!</Alert>
            )}
